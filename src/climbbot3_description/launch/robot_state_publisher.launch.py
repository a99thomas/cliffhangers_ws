...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'workspaces/automatic_ws/src/mycobot_ros2/mycobot_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'workspaces/automatic_ws/install/mycobot_moveit_config/share/mycobot_moveit_config/config',
        robot_name
    )
