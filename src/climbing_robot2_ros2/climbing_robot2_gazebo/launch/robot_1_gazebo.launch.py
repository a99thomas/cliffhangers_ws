...
def generate_launch_description():
  ...
  package_name_description = 'climbing_robot2_gazebo'
  package_name_gazebo = 'climbing_robot2_gazebo'

  default_robot_name = 'robot_1'
  gazebo_launch_file_path = 'launch'
  gazebo_models_path = 'models'
  ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
  rviz_config_file_path = 'rviz/robot_1_arduino_view_description.rviz'
  urdf_file_path = 'urdf/climbing_robot_gazebo.urdf.xacro' 
